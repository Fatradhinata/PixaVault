          ...
          <div class="container">
            ...
            <div class="mil-banner-content">
              <div class="row align-items-end">
                <div class="col-xl-7">
                  <div class="mil-mb-90">
                    <span class="mil-suptitle mil-light mil-upper mil-mb-60"
                      >Pixel Vault</span
                    >
                    <h1 class="mil-upper mil-light mil-mb-60">
                      Unlocking<br /><span class="mil-accent">the Future</span
          ...
          <div class="container-fluid mil-p-0-60">
            <div class="col-12">
              <div class="mil-center mil-mb-90 mt-5">
                ...
                <a href="blog.html" class="mil-link mil-upper mil-up"
                  >See All
                  <span class="mil-arrow"
                    ><img src="img/icons/1.svg" alt="arrow" /></span
                ></a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 col-lg-3">
                <a
                  href="project.html"
                  class="mil-portfolio-item mil-square-item mil-up mil-mb-30 position-relative"
                >
                  <!-- Gambar -->
                  <img
                    src="img/foto/1.jpg"
                    alt="cover"
                    class="mil-image no-save"
                  />

                  <!-- Profil di kiri bawah -->
                  <div class="mil-profile">
                    <img
                      src="img/faces/user.jpg"
                      alt="Profile Picture"
          ...
          <div class="container-fluid mil-p-0-60">
            ...
            <div class="row">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div
                    class="col-md-6 col-lg-12 d-flex flex-row gap-02 align-items-center"
                  >
                    <div class="col-lg-6">
                      <a
                        href="project.html"
                        class="mil-portfolio-item mil-square-item mil-up mil-mb-30 p-50"
                      >
                        <img src="img/foto/1.jpg" alt="cover" />
                      </a>
                    </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-md-6 col-lg-3 mil-mb-20">
                    <a
                      href="project.html"
                      class="mil-portfolio-item p-70 mil-up mil-mb-10 rounded-1"
                    >
                  ...
                  <div class="col-md-6 col-lg-3 mil-mb-20">
                    ...
                    >
                      <img
                        src="img/foto/category/urban-cityscape.jpg"
                        alt="cover"
                      />
                      <!-- <div class="mil-project-descr"> -->
                      <!-- <h4 class="mil-upper mil-mb-20">Cubism</h4> -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-3 mil-mb-20">
                    ...
                    >
                      <img
                        src="img/foto/category/black-white.jpg"
                        alt="cover"
                      />
                      <!-- <div class="mil-project-descr"> -->
                      <!-- <h4 class="mil-upper mil-mb-20">Cubism</h4> -->
...
<?php echo $__env->make('templates.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FATRA\OneDrive\Documents\SMK\PAS\PixaVault\template\resources\views/user/home.blade.php ENDPATH**/ ?>