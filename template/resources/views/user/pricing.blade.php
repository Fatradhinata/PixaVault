    ...
    <div class="container mil-p-120-90 price">
      ...
      <div class="col-lg-6">
        ...
        <div class="mil-price-body">
          ...
          <li class="mil-accent mil-up"><img src="{{ Vite::asset('resources/img/icons/checklist-black.svg') }}"
            style="width: 47.65px; height: 37px; padding: 7px;" alt="icon"> Free access Download Photo</li>
          <li class="mil-accent mil-up"><img src="{{ Vite::asset('resources/img/icons/checklist-black.svg') }}"
            style="width: 47.65px; height: 37px; padding: 7px;" alt="icon"> Free access Upload Photo</li>
          </ul>
        </div>
