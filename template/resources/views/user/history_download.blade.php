...
@section('content')
    ...
    <div id="content">
        ...
        <section class="mil-banner history">
            <img src="img/foto/1.jpg" class="background-content-image mil-bg-img mil-scale" data-value-1=".4" data-value-2="1.4" alt="image" />
        ...
        <footer class="mil-relative">
            <img src="img/foto/4.jpg" class="mil-bg-img mil-parallax" alt="image" style="object-position: top" data-value-1="-25%" data-value-2="23%" />
