                            ...
                            <table class="table align-items-center mb-0" id="datatable-init">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-dark text-xs font-weight-bolder">Reported User</th>
                                    ...
                                    @foreach ($report as $index => $item)
                                        <tr>
                                            ...
                                            <td class="px-4">
                                                <div class="d-flex py-1">
                                                    <div>
                                                        <img src="{{ $item->reportedUser?->photo ? asset('storage/profile_photos/' . $item->reportedUser->photo) : asset('img/icons/user-elipse.svg') }}"
                                                            class="avatar avatar-sm me-3" loading="lazy" alt="User Profile">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $item->reportedUser?->name ?? 'anonymous' }}</h6>
                                                        <p class="text-xs text-secondary mb-0">{{ $item->reportedUser?->email ?? '-' }}</p>
                                                    </div>
                                                </div>
                                            </td>
