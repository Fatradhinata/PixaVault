                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 text-center">
                                                <div class="text-center flex justify-center space-x-4">
                                                    <img src="../assets/img/weui_eyes-on-filled.svg" alt="read" class="w-24 h-24 cursor-pointer hover:opacity-75 active:scale-90 transition">
                                                    <img src="../assets/img/material-symbols_delete.svg" alt="delete" class="w-24 h-24 cursor-pointer hover:opacity-75 active:scale-90 transition">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
