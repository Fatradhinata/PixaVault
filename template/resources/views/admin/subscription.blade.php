...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('admin.subscription') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 " style="margin-top: 60%;">
      <a class="btn btn-dark mt-3 w-100"
              ...
              <div class="controls">
                ...
                <div class="show-entries">
                  ...
                  <div class="action-create">
                    <a href="action/create-subscription.html">
                      <img src="/img/icons/create.svg" width="33px" height="33px" alt="">
                    </a>
                  </div>
                </div>
              </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-dark text-xs font-weight-bolder ">user id</th>
                      ...
                      <th class="text-center text-uppercase text-dark text-xs font-weight-bolder ">updated at</th>
                  ...
                  <tbody>
                    <tr>
                      <td class="align-middle text-center px-4">
                        <span
                          class="text-secondary text-xs font-weight-bold">0db00c51-39d4-4594-ae49-20da1e4ba21c</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span
                          class="text-secondary text-xs font-weight-bold">9e3b4270-b919-44f3-a4db-0f24c99dd3a4</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span
                          class="text-secondary text-xs font-weight-bold">1 Month</span>
                      </td>
                      <td class="px-4 text-center">
                        <span class="text-secondary text-xs font-weight-bold">XE5GECLJO6</span>
                      </td>
                      <td class="px-4 text-center">
                        <p class="text-sm font-weight-bold mb-0">Rp 113.576</p>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span class="text-secondary text-xs">Active</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span class="text-secondary text-xs">2025-03-17</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span class="text-secondary text-xs">2025-02-17 16:47:18</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span class="text-secondary text-xs">2025-02-17 16:47:35</span>
                      </td>
                      <td class="px-4 text-center">
