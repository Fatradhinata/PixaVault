...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('admin.user-admin') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-dark text-xs font-weight-bolder ">username</th>
                      ...
                      <th class="text-center text-uppercase text-dark text-xs font-weight-bolder ">profile picture</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle text-center px-4">
                        <span
                          class="text-secondary text-xs font-weight-bold">TylerBlack</span>
                      </td>
                      <td class="align-middle text-center px-4">
                        <span
                          class="text-secondary text-xs font-weight-bold">The Tyler Black</span>
                      </td>
                      <td class="px-4 text-center">
                        <span class="text-secondary text-xs font-weight-bold">snapshort11@gmail.com</span>
                      </td>
                      <td class="px-4 text-center">
                      ...
                      <td class="align-middle text-center px-4">
                        <span class="text-secondary text-xs">15</span>
                      </td>
                      <td class="align-middle text-center px-4">
